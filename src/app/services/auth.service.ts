...
export class AuthService {
  ...
  login(loginModel: LoginModel): Observable<SingleResponseModel<UserTokenModel>> {
    return this.httpClient.post<SingleResponseModel<UserTokenModel>>(`${this.apiControllerUrl}/login`, loginModel);
  }
